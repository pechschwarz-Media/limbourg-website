    ...
    'group cursor-pointer font-base w-full md:w-auto inline-flex justify-center items-center gap-x-theme-lg disabled:opacity-50 focus-visible:outline-2 focus-visible:outline-offset-2',
    {
        variants: {
            variant: {
                ...
                light: 'bg-background-primary text-text-primary border border-border-secondary h-10 md:h-12 rounded-none px-theme-2xl rounded-md md:rounded-xl transition-all flex lg:inline-flex',
