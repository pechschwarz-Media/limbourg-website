...
export default function Faq_2(content: Faq2Props) {
    ...
    return (
        <Section
            ...
            <div className="container space-y-theme-8xl">
                <motion.div
                ...
                <div className="grid lg:grid-cols-12 justify-center gap-x-theme-3xl">
