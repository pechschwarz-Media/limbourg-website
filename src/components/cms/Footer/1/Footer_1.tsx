...
const footerVariants = cva('py-theme-6xl text-small', {
    variants: {
        variant: {
            light: 'bg-neutral-25',
...
const footerMainVariants = cva('sm:py-theme-6xl lg:border-b', {
    variants: {
        variant: {
...
const footerNavVariants = cva('border-b lg:border-b-0 py-theme-2xl lg:py-0', {
    variants: {
        variant: {
            light: 'border-b-neutral-300',
            dark: 'border-b-neutral-600',
...
const footerLinkVariants = cva('relative hover:text-brand-secondary-200 transition-all', {
    variants: {
        variant: {
    ...
    return (
        <footer className={cn(footerVariants({ variant }))}>
            <div className="container">
                <div className={cn(footerTopVariants({ variant }))}>
                    <nav
                        role="navigation"
                        aria-label="Breadcrumb">
                        <ul className="flex flex-wrap items-center gap-x-theme-lg">
                            <li>
                                <Link
                                    href="#"
                ...
                <div className={cn(footerMainVariants({ variant }))}>
                    <div className="grid justify-between grid-cols-1 lg:auto-cols-fr lg:grid-flow-col gap-x-theme-3xl">
                        <nav
                            className={cn(footerNavVariants({ variant }))}
                            role="navigation"
                            aria-label="Footernavigation">
                            <button
                                className="text-large lg:text-base font-highlight flex items-center justify-between w-full"
                                aria-label="Menü öffnen"
                                aria-expanded={menuIndex === 0}
                                onClick={() => {
                                    setMenuIndex(menuIndex === 0 ? null : 0);
                                }}>
                                Products
                                <IconChevronDown
                                    className={cn(
                                        'size-5 transition-transform lg:hidden',
                                        menuIndex === 0 && 'rotate-180',
                                    )}
                                />
                            </button>
                            <div
                                className={cn(
                                    'hidden lg:block mt-theme-2xl sm:mt-theme-xl',
                                    menuIndex === 0 && 'block',
                                )}>
                                <ul className="space-y-theme-xl">
                                    <li>
                                        <Link
                                            href="#"
                                            role="menuitem"
                                    ...
                                    <li>
                                        <Link
                                            ...
                                            <Tag
                                                variant="info"
                                                className="absolute whitespace-nowrap ml-theme-lg left-full top-1/2 -translate-y-1/2">
                                                New
                                            </Tag>
                                        </Link>
                                    </li>
                        ...
                        <nav
                            ...
                            <button
                                className="text-large lg:text-base font-highlight flex items-center justify-between w-full"
                                aria-label="Menü öffnen"
                                aria-expanded={menuIndex === 1}
                                onClick={() => {
                                    setMenuIndex(menuIndex === 1 ? null : 1);
                                }}>
                                Ressources
                                <IconChevronDown
                                    className={cn(
                                        'size-5 transition-transform lg:hidden',
                                        menuIndex === 1 && 'rotate-180',
                                    )}
                                />
                            </button>
                            <div
                        ...
                        <nav
                            ...
                            <button
                                className="text-large lg:text-base font-highlight flex items-center justify-between w-full"
                                aria-label="Menü öffnen"
                                aria-expanded={menuIndex === 2}
                                onClick={() => {
                                    setMenuIndex(menuIndex === 2 ? null : 2);
                                }}>
                                Company
                                <IconChevronDown
                                    className={cn(
                                        'size-5 transition-transform lg:hidden',
                                        menuIndex === 2 && 'rotate-180',
                                    )}
                                />
                            </button>
                            <div
                        ...
                        <nav
                            ...
                            <button
                                className="text-large lg:text-base font-highlight flex items-center justify-between w-full"
                                aria-label="Menü öffnen"
                                aria-expanded={menuIndex === 3}
                                onClick={() => {
                                    setMenuIndex(menuIndex === 3 ? null : 3);
                                }}>
                                Pricing
                                <IconChevronDown
                                    className={cn(
                                        'size-5 transition-transform lg:hidden',
                                        menuIndex === 3 && 'rotate-180',
                                    )}
                                />
                            </button>
                            <div
