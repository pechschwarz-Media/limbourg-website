...
const headerVariants = cva('navbar fixed z-40 top-0 left-0 w-full text-text-alternate h-[72px]', {
    variants: {
        variant: {
            glass: 'bg-neutral-900/15 lg:bg-transparent text-text-alternate',
            light: 'bg-neutral-100 lg:bg-transparent text-text-primary',
            dark: 'bg-brand-primary-950 lg:bg-transparent text-text-alternate',
        },
        background: {
            true: '',
            false: '',
    ...
    compoundVariants: [
        {
            variant: 'light',
            background: true,
            class: 'lg:bg-neutral-25',
        },
        {
            variant: 'dark',
            background: true,
            class: 'lg:bg-brand-primary-950',
        },
    ],
    defaultVariants: {
        variant: 'glass',
...
const navVariants = cva('absolute -z-10 inset-0 rounded-md', {
    variants: {
        variant: {
            glass: 'backdrop-blur bg-neutral-900/15',
...
const linkVariants = cva('flex items-center gap-theme-md h-8 px-theme-lg rounded-xs transition-all font-highlight', {
    variants: {
        variant: {
...
type Navbar2Props = VariantProps<typeof headerVariants>;

export default function Navbar_2({ variant = 'glass', background = false }: Navbar2Props) {
    ...
    return (
        <>
            <header className={cn(headerVariants({ variant, background }))}>
                {variant === 'glass' && <div className="lg:hidden absolute -z-10 inset-0 backdrop-blur"></div>}
                <div className="container h-full">
                    <div className="h-full flex gap-x-theme-xl items-center justify-between">
                        ...
                        <div className="hidden lg:flex relative h-12 px-theme-md items-center">
                            <div className={cn(navVariants({ variant }))}></div>
                            <nav
                                role="navigation"
